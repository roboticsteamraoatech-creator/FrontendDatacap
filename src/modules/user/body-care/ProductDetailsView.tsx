...
interface ProductDetailsViewProps {
  ...
  onMakePayment: (
    product: ExtendedPublicProductDetails,
...
const ProductDetailsView = ({
  ...
  const {
    ...
    remainingBalance,
  } = selectedProduct.product.pricing;
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="ml-0 md:ml-[350px] pt-8 md:pt-8 p-4 md:p-8">
        <div className="max-w-7xl mx-auto">
          ...
          <button
            onClick={onBack}
            className="mb-6 text-purple-600 hover:text-purple-700 font-medium flex items-center hover:cursor-pointer"
          >
            ← Back to{" "}
          ...
          <div className="bg-white rounded-xl shadow-sm overflow-hidden border-2 border-[#5d2a8b]">
            ...
            <div className="p-6">
                ...
                <div>
                  ...
                  {selectedProduct.product.images.all.length > 0 && (
                    <div className="grid grid-cols-3 gap-2">
                      {selectedProduct.product.images.all
                        .slice(0, 3)
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="text-lg font-bold text-gray-500 line-through">
                          {formatCurrency(originalPrice + platformChargeAmount)}
                        </p>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <p className="text-lg font-bold text-green-600">
                          {formatCurrency(
                            Math.abs(selectedProduct.product.pricing.youSave),
                          )}
                        </p>
                      </div>
                      <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="font-semibold">
                          {selectedProduct.product.productInfo.category}
                        </p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600 font-medium">
                        ...
                        <p className="font-semibold">
                          {selectedProduct.product.productInfo.industry}
                        </p>
                      </div>
                      {selectedProduct.product.itemType === "product" && (
                        <div className="flex flex-col space-y-4">
                          <div>
                            ...
                            <p className="font-semibold">
                              {
                                selectedProduct.product.productInfo
                                  .availableQuantity
                              }{" "}
                              units
                            </p>
                          ...
                          <div>
                            ...
                            <p className="text-gray-700">
                              {selectedProduct.product.paymentMethods}
                            </p>
                          </div>
                        </div>
                      )}
                      <div className="flex flex-col space-y-4">
                        ...
                        <div>
                          ...
                          <p className="font-mono text-sm">
                            {selectedProduct.product.productInfo.sku}
                          </p>
                        </div>
                        ...
                        <div>
                          ...
                          <p className="font-mono text-sm">
                            {selectedProduct.product.productInfo.upc}
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                hasSubServices && (
                  <div className="bg-gray-50 p-6 rounded-lg mt-6">
                    ...
                    <p className="text-gray-600 mb-4">
                      This service has {subServices.length} sub-services
                      available. Select one to proceed.
                    </p>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      {subServices.map(
                        (subService: SubService, index: number) => (
                          <div
                            key={index}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="font-semibold text-lg">
                      {selectedProduct.serviceProvider.producer}
                    </p>
                  </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg mt-6">
                ...
                <div className="space-y-4">
                  {selectedProduct.serviceLocations.map(
                      ...
                      >
                        <div className="flex justify-between items-start">
                          ...
                          <span className="bg-[#5d2a8b]/10 text-[#5d2a8b] text-xs px-2 py-1 rounded-full">
                            Service Fee: {formatCurrency(originalPrice + platformChargeAmount)}
                          </span>
                        </div>
              ...
              {selectedProduct.product.itemType === "service" &&
                hasSubServices && (
                  <div className="mt-8 text-center text-gray-600">
                    <p className="mb-2">
                      Please select a sub-service above to proceed with payment
                      or booking.
                    </p>
                  </div>
                )}
