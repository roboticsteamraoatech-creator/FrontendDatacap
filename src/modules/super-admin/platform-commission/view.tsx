    ...
    return (
      <div className="manrope">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-2xl font-bold text-[#1A1A1A]">Platform Commission Details</h1>
        </div>
      ...
      <div className="manrope">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 max-w-3xl">
          <div className="text-center py-8">
            <p className="text-gray-600">Platform commission not found</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 max-w-3xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-900">{commission.category}</p>
          </div>
          <div>
            <h2 className="text-lg font-semibold text-gray-700 mb-2">Industry</h2>
            <p className="text-gray-900">{commission.industry}</p>
          </div>
        ...
        <div className="flex justify-end space-x-4">
          <button
            onClick={() => window.location.href = `/super-admin/platform-commission/edit/${commission.id}`}
