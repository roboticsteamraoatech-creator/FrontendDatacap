    ...
    <div className="manrope">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 max-w-3xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div>
            <h2 className="text-lg font-semibold text-gray-700 mb-2">Category Name</h2>
            <p className="text-gray-900">{category.name}</p>
          </div>
          <div>
            <h2 className="text-lg font-semibold text-gray-700 mb-2">Industry</h2>
            <p className="text-gray-900">{category.industryName}</p>
          </div>
        ...
        <div className="flex justify-end space-x-4">
          <button
            onClick={() => window.location.href = `/super-admin/category/edit/${category.id}`}
