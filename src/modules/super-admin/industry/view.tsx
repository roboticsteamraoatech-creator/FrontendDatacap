    ...
    return (
      <div className="manrope">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-2xl font-bold text-[#1A1A1A]">Industry Details</h1>
        </div>
    ...
    <div className="manrope">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 max-w-3xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div>
            <h2 className="text-lg font-semibold text-gray-700 mb-2">Industry Name</h2>
            <p className="text-gray-900">{industry.name}</p>
          </div>
          <div>
            <h2 className="text-lg font-semibold text-gray-700 mb-2">Created Date</h2>
            <p className="text-gray-900">{formatDate(industry.createdAt)}</p>
          </div>
          <div className="md:col-span-2">
            <h2 className="text-lg font-semibold text-gray-700 mb-2">Description</h2>
            <p className="text-gray-900">{industry.description}</p>
          </div>
          <div>
            <h2 className="text-lg font-semibold text-gray-700 mb-2">Last Updated</h2>
            <p className="text-gray-900">{formatDate(industry.updatedAt)}</p>
          </div>
        </div>

        <div className="flex justify-end space-x-4">
          <button
            onClick={() => window.location.href = `/super-admin/industry/edit/${industry.id}`}
