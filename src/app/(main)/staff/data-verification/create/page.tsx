...
export default function CreateDataVerificationPage() {
  ...
  const handleNestedInputChange = (section: keyof FormData, field: string, value: any) => {
    setFormData(prev => {
      ...
      // Check if the section is an object type
      ...
      // If not an object, return the original data
      return prev;
    });
  };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await dataVerificationService.createVerification(requestData);
    ...
    <div className="manrope ml-0 md:ml-[350px] pt-8 md:pt-8 p-4 md:p-8 min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <div>
            <h1 className="text-2xl font-bold text-[#1A1A1A]">Create Data Verification</h1>
            <p className="text-gray-600">Fill in the verification details for the organization</p>
          </div>
        </div>
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      Upload utility bills or other documents proving the address
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <p className="text-sm text-gray-600">Transportation cost details will be calculated automatically based on the journey.</p>
                  </div>
                </div>
              </div>
            </div>
